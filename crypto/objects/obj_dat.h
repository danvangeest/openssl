...
static const unsigned char so[9571] = {
    ...
    0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x09,0x10,0x0D,  /* [ 9516] OBJ_id_smime_ori */
    0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x09,0x10,0x03,0x1C,  /* [ 9526] OBJ_HKDF_SHA256 */
    0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x09,0x10,0x03,0x1D,  /* [ 9537] OBJ_HKDF_SHA384 */
    0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x09,0x10,0x03,0x1E,  /* [ 9548] OBJ_HKDF_SHA512 */
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"id-smime-ori", "id-smime-ori", NID_id_smime_ori, 10, &so[9516]},
    {"id-alg-hkdf-with-sha256", "HKDF-SHA256", NID_HKDF_SHA256, 11, &so[9526]},
    {"id-alg-hkdf-with-sha384", "HKDF-SHA384", NID_HKDF_SHA384, 11, &so[9537]},
    {"id-alg-hkdf-with-sha512", "HKDF-SHA512", NID_HKDF_SHA512, 11, &so[9548]},
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1488,    /* "id-alg-hkdf-with-sha256" */
    1489,    /* "id-alg-hkdf-with-sha384" */
    1490,    /* "id-alg-hkdf-with-sha512" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1487,    /* OBJ_id_smime_ori                 1 2 840 113549 1 9 16 13 */
    ...
    1488,    /* OBJ_HKDF_SHA256                  1 2 840 113549 1 9 16 3 28 */
    1489,    /* OBJ_HKDF_SHA384                  1 2 840 113549 1 9 16 3 29 */
    1490,    /* OBJ_HKDF_SHA512                  1 2 840 113549 1 9 16 3 30 */
    ...
    1491,    /* OBJ_id_smime_ori_kem             1 2 840 113549 1 9 16 13 3 */
