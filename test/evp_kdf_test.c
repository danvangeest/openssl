...
static int test_kdf_hkdf_fixed_digest_helper(const char *kdf_name, char *digest)
{
    int ret;
...
{
    return test_kdf_hkdf_fixed_digest_helper(OSSL_KDF_NAME_HKDF_SHA256, "sha256")
        && test_kdf_hkdf_fixed_digest_helper(OSSL_KDF_NAME_HKDF_SHA384, "sha384")
        && test_kdf_hkdf_fixed_digest_helper(OSSL_KDF_NAME_HKDF_SHA512, "sha512");
}
...
static int test_kdf_hkdf_fixed_digest_set_digest_helper(const char *kdf_name, char *digest)
{
    int ret;
    EVP_KDF_CTX *kctx = NULL;
    OSSL_PARAM *params;
...
static int test_kdf_hkdf_fixed_digest_set_digest(void)
{
    return test_kdf_hkdf_fixed_digest_set_digest_helper(OSSL_KDF_NAME_HKDF_SHA256, "sha256")
        && test_kdf_hkdf_fixed_digest_set_digest_helper(OSSL_KDF_NAME_HKDF_SHA384, "sha384")
        && test_kdf_hkdf_fixed_digest_set_digest_helper(OSSL_KDF_NAME_HKDF_SHA512, "sha512");
}
...
int setup_tests(void)
{
    ...
    ADD_TEST(test_kdf_hkdf_fixed_digest_set_digest);
